...
const V = TAKATA_VIEWS;
  ...
  const ROUTES = [
    ...
    [/^\/installations$/, (p, q) => V.installationsView(), 'Abonnements', true, 'tournees', 'installations'],
    [/^\/installations\/new$/, (p, q) => V.installationFormView(q), 'Nouvel abonnement', true, null, null],
    [/^\/installations\/(\d+)$/, (p, q) => V.installationDetailView({ id: p[0] }), 'Abonnement', true, null, null],
